package com.bluelaned.storyapp2.data.repository
...
import com.bluelaned.storyapp2.data.retrofit.ApiService
import com.bluelaned.storyapp2.Response.*
import com.bluelaned.storyapp2.data.database.StoryRemoteMediator
...
class StoryRepository private constructor(
    ...
    fun uploadStories(token: String, imageFile: File, description: String, lat: Double?, lon: Double?) = liveData {
        ...
        try {
            val successResponse = apiService.postStory("Bearer $token", multipartBody, requestBody, requestLat, requestLon)
    ...
    companion object {
        ...
        fun getInstance(
            ...
            instance ?: synchronized(this) {
                instance ?: StoryRepository(dataBase, preferences, apiService)
            }.also { instance = it }
    }
}